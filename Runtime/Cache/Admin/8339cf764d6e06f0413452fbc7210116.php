    ...
    <div class="row">
        <div class="col-lg-12  ">
            <div class="ibox float-e-margins">
                ...
                <?php if(is_array($rInfo)): $kkey = 0; $__LIST__ = $rInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($kkey % 2 );++$kkey;?><form class="form-horizontal m-t content-form"  method="post" <?php if($item["range_title"] == ''): ?>style="display:none;"<?php endif; ?> >
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input name="form[<?php echo ($key); ?>][title]" class="form-control input-title" type="text" value="<?php echo ($item["range_title"]); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <img id="course_image_6" src="<?php echo ($item["range_img"]); ?>" alt="" width="100%" height="200">
                                <button onclick="clickInputFile(this)" class="btn" type="button">上传</button><br/>
                                <input type="text" style="width: 400px;margin-top: 3px;"  name="form[<?php echo ($key); ?>][img]" value="<?php echo ($item["range_img"]); ?>">
...
<script type="text/javascript">
    ...
    function editSubmit(groupId){
        ...
        $.post('<?php echo U("Range/edit");?>',postData,function(result){
//            console.log(result);
//            alert(result.info);
