                ...
                <div class="ibox-content">
                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline" role="grid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <button id="btn_skip_target" class="btn btn-info" onclick="location.href = '<?php echo U('Video/add');?>'">添加视频</button>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example dataTable no-footer">
                            ...
                            <tr role="row">
                                ...
                                <!--<th class="sorting">视频ID</th>-->
                                <th class="sorting">视频标题</th>
                            ...
                            <?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr class="gradeX">
                                    ...
                                    <td><?php echo ($list["video_link"]); ?></td>
                                    <!--<td><?php echo (getStatusName($list["video_status"])); ?></td>-->
                                    <td>
                                        <a href="<?php echo U('Video/edit',array('groupId'=>$list['group_id']));?>" class="btn btn-primary" style="margin-bottom:0px;padding: 2px 9px;font-size:12px;">编辑</a>&nbsp;&nbsp;
                                        ...
                                        <!--<a href="<?php echo U('Video/revoke',array('video_id'=>$list['video_id']));?>" class="btn btn-primary" style="margin-bottom:0px;padding: 2px 9px;font-size:12px;">撤销</a>&nbsp;&nbsp;-->
                                        <!--<a href="<?php echo U('Video/publish',array('video_id'=>$list['video_id']));?>" class="btn btn-primary" style="margin-bottom:0px;padding: 2px 9px;font-size:12px;">发布</a>&nbsp;&nbsp;-->
                                    </td>
                ...
                $.ajax({
                    ...
                    success:function(data){
                        if(data.status == 1){
                            ...
                            window.location.href = "<?php echo U('Video/index');?>";
                        }else{
                            bootbox.alert({
                                message: data.msg,
                                buttons: {
