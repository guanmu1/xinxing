...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main_content">
    	<div id="templatemo_sidebar">
            ...
            <div class="sidebar_content_box" style="background:#fff;padding:0;">
                <ul  style="padding:0;">
                    ...
                    <li style="height: 1px;background-color: #9FA0A1;"></li>
                    <li class="mouseover-li left-sub-menu-hover" style="margin-bottom: 10px;margin-top: 10px;"><a class="left-sub-menu-a-hover" href="<?php echo U('Goods/index');?>" ><?php echo L('搜索');?></a></li>
        ...
        <div id="templatemo_content" style="border:none;">
            ...
            <div class="sidebar_content_box" style="height:100px;">
                <h3 class="h3-content"><?php echo L('产品展示');?></h3>
            </div>
            <div class="goods_search">
                <input id="search_search_input" type="text" style="width: 540px;height: 30px;float: left;padding-left: 10px;" placeholder="请输入产品关键字" value="<?php echo ($_GET['keyword']); ?>">
                <button class="search-botton" onclick="searchSearchGoods()" ><?php echo L('搜索');?></button>
                <div style="clear: both;"></div>
                <h4 style=" font-size: 14px;color: gray;margin-left: 35px;">搜索到与 "<?php echo ($_GET['keyword']); ?>" 相关的产品有 <?php echo ($count); ?> 个</h4>
            </div>
...
<script>
    function searchSearchGoods(){
        var url = "<?php echo U('Goods/search');?>";
        var keyword = $('#search_search_input').val();
        location.href = url+"?keyword="+keyword;
    }
</script>
<style>
