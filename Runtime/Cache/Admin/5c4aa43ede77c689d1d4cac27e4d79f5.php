    ...
    <div class="row">
        <div class="col-lg-12  ">
            <div class="ibox float-e-margins">
                ...
                <?php if(is_array($rInfo)): $kkey = 0; $__LIST__ = $rInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($kkey % 2 );++$kkey;?><form class="form-horizontal m-t content-form"  method="post" <?php if($item["recruit_title"] == ''): ?>style="display:none;"<?php endif; ?> >
                        <div class="ibox-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name="form[<?php echo ($key); ?>][title]" class="form-control input-title" type="text" value="<?php echo ($item["recruit_title"]); ?>">
                                </div>
                            </div>
                ...
                <div style="margin-top: 10px;" class="form-group">
                    <div class="col-sm-3 " style="float: right;">
                        ...
                        <a class="btn btn-primary" href="<?php echo U('Recruit/index');?>">取消</a>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    ue_cn.ready(function() {
        ue_cn.setContent('<?php echo ($rInfo[0]["recruit_content"]); ?>');
    });
    ue_en.ready(function() {
        ue_en.setContent('<?php echo ($rInfo[1]["recruit_content"]); ?>');
    });
    ue_fr.ready(function() {
        ue_fr.setContent('<?php echo ($rInfo[2]["recruit_content"]); ?>');
    });
    ue_es.ready(function() {
        ue_es.setContent('<?php echo ($rInfo[3]["recruit_content"]); ?>');
    });
    ue_pt.ready(function() {
        ue_pt.setContent('<?php echo ($rInfo[4]["recruit_content"]); ?>');
    });
    ue_ru.ready(function() {
        ue_ru.setContent('<?php echo ($rInfo[5]["recruit_content"]); ?>');
    });
    ue_ar.ready(function() {
        ue_ar.setContent('<?php echo ($rInfo[6]["recruit_content"]); ?>');
    });
...
//    }
    ...
    function editSubmit(groupId){
        ...
        $.post('<?php echo U("Recruit/edit");?>',postData,function(result){
//            console.log(result);
//            alert(result.info);
