            ...
            <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <img id="course_image_0" src="" alt="" width="100%" height="480">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <img id="course_image_1" src="" alt="" width="100%" height="480">
                                <button onclick="clickInputFile(this)" class="btn" type="button">上传</button>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <img id="course_image_2" src="" alt="" width="100%" height="480">
                                <button onclick="clickInputFile(this)" class="btn" type="button">上传</button>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <img id="course_image_3" src="" alt="" width="100%" height="480">
                                <button onclick="clickInputFile(this)" class="btn" type="button">上传</button>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <img id="course_image_4" src="" alt="" width="100%" height="480">
                                <button onclick="clickInputFile(this)" class="btn" type="button">上传</button>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <img id="course_image_5" src="" alt="" width="100%" height="480">
                                <button onclick="clickInputFile(this)" class="btn" type="button">上传</button>
                                <input type="hidden" name="form[0][img]" value="">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <img id="course_image_6" src="" alt="" width="100%" height="480">
                                <button onclick="clickInputFile(this)" class="btn" type="button">上传</button>
                ...
                <div style="margin-top: 10px;" class="form-group">
                    <div class="col-sm-3 " style="float: right;">
                        ...
                        <a class="btn btn-primary" href="<?php echo U('ImageHome/index');?>">取消</a>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function addSubmit(){
        ...
        $.post('<?php echo U("ImageHome/add");?>',postData,function(result){
//            console.log(result);
//            alert(result.info);
