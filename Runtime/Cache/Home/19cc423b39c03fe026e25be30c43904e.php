    ...
    <div id="templatemo_main_content">
    	<div id="templatemo_sidebar">
            <div class="sidebar_content_box" style="height:100px;">
                <h3 style="text-align:center;margin-top:20px;color:red;font-weight:bold;"><?php echo L('媒体中心');?></h3>
            ...
            <div class="sidebar_content_box" style="background:#fff;padding:0;">
                <ul  style="padding:0;">
                    <li class="mouseover-li left-sub-menu-hover"><a class="left-sub-menu-a-hover" href="<?php echo U('Video/index');?>" ><?php echo L('视频广告');?></a></li>
                    <!--<li class="mouseover-li left-sub-menu"><a class="left-sub-menu-a" href="#" >公司简介</a></li>-->
        ...
        <div id="templatemo_content">
            ...
            <div class="sidebar_content_boxx" style="height:100px;">
                <h3 class="h3-content"><?php echo L('视频广告');?></h3>
            </div>

            <div class="news_container">
                <?php if(is_array($_list)): foreach($_list as $key=>$item): ?><div class="" style="margin-bottom: 40px;">
                        <div class="" style="background-color: #EEEFF0;">
                            <div style="width:20px;background: red;height: 35px;float: left;"></div>
                            <span class="news-title-text" style="font-size: 16px;"><?php echo ($item["video_title"]); ?></span>
                            <span class="news-title-text" style="font-size: 16px;float: right;margin-right: 20px;"> <?php echo (date("Y/m/d",$item["create_time"])); ?></span>
                        </div>

                        <?php if(strpos('http://',$item.video_link) !== false): ?><embed style="width:100%;height: 350px;margin-top: 15px;" class="img_border img_border_b"  src="<?php echo ($item["video_link"]); ?>" allowScriptAccess="always" allowFullScreen="true" mode="transparent" type="application/x-shockwave-flash"></embed>
                            <?php else: ?>
                            <embed src="<?php echo ($item["video_link"]); ?>" style="width:100%;height: 350px;margin-top: 15px;" autostart='false' loop='true'></embed><?php endif; ?>
