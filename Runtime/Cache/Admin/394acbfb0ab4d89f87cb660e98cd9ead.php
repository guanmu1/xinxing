    ...
    <div class="row">
        <div class="col-lg-12  ">
            <div class="ibox float-e-margins">
                ...
                <?php if(is_array($rInfo)): $kkey = 0; $__LIST__ = $rInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($kkey % 2 );++$kkey;?><form class="form-horizontal m-t content-form"  method="post" <?php if($item["image_link"] == ''): ?>style="display:none;"<?php endif; ?> >
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input name="form[<?php echo ($key); ?>][title]" class="form-control input-title" type="text" value="<?php echo ($item["image_title"]); ?>">
                            </div>
                        </div>
