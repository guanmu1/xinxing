                ...
                <div class="ibox-content">
                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline" role="grid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <button id="btn_skip_target" class="btn btn-info" onclick="location.href = '<?php echo U('Goods/add');?>'">添加商品</button>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example dataTable no-footer">
                            ...
                            <tr role="row">
                                ...
                                <th style="background: transparent;width:200px;" class="text-center">操作</th>
                            ...
                            <?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr class="gradeX" <?php if($list["show_home"] == 1): ?>style="background:#bdecf9;"<?php endif; ?>>
                                    ...
                                    <td><?php echo ($list["category_pname"]); ?></td>
                                    ...
                                    <td>
                                        <a href="<?php echo U('Goods/edit',array('groupId'=>$list['group_id']));?>" class="btn btn-primary" style="margin-bottom:0px;padding: 2px 9px;font-size:12px;">编辑</a>&nbsp;
                                        <a onclick="del(this)" rel-group="<?php echo ($list['group_id']); ?>" class="btn btn-primary" style="margin-bottom:0px;padding: 2px 9px;font-size:12px;">删除</a>&nbsp;
                                        <?php if($list["show_home"] != 1): ?><a href="<?php echo U('Goods/setShowHome',array('groupId'=>$list['group_id'],'categoryPid'=>$list['category_pid']));?>" class="btn btn-primary" style="margin-bottom:0px;padding: 2px 9px;font-size:12px;">设置首页展示</a><?php endif; ?>
