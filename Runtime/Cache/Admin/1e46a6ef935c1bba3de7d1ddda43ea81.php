                ...
                <div class="ibox-content">
                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline" role="grid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <button id="btn_skip_target" class="btn btn-info" onclick="location.href = '<?php echo U('ImageOther/add');?>'">新增其他页轮播图</button>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example dataTable no-footer">
                            ...
                            <?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr class="gradeX">
                                    ...
                                    <td><?php echo ($list["image_title"]); ?></td>
                                    <td><img src="<?php echo ($list["image_link"]); ?>" alt=""  height="30"></td>
                                    <!--<td><?php echo (getStatusName($list["video_status"])); ?></td>-->
                                    <td>
                                        <a href="<?php echo U('ImageOther/edit',array('groupId'=>$list['group_id']));?>" class="btn btn-primary" style="margin-bottom:0px;padding: 2px 9px;font-size:12px;">编辑</a>&nbsp;&nbsp;
                                        ...
                                        <!--<a href="<?php echo U('ImageOther/revoke',array('honor_id'=>$list['honor_id']));?>" class="btn btn-primary" style="margin-bottom:0px;padding: 2px 9px;font-size:12px;">撤销</a>&nbsp;&nbsp;-->
                                        <!--<a href="<?php echo U('ImageOther/publish',array('honor_id'=>$list['honor_id']));?>" class="btn btn-primary" style="margin-bottom:0px;padding: 2px 9px;font-size:12px;">发布</a>&nbsp;&nbsp;-->
                                    </td>
...
//                                }
//                            });
                            window.location.href = "<?php echo U('ImageOther/index');?>";
                        }else{
                            bootbox.alert({
                                message: data.msg,
                                buttons: {
