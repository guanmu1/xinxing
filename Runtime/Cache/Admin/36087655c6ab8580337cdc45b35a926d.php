                ...
                <div class="ibox-content">
                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline" role="grid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <button id="btn_skip_target" class="btn btn-info" onclick="location.href = '<?php echo U('News/add');?>'">添加历史沿革</button>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example dataTable no-footer">
                            ...
                            <?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr class="gradeX">
                                    ...
                                    <td><?php echo ($i); ?></td>
                                    <td><?php echo ($list["news_time"]); ?></td>
                                    <td><?php echo ($list["news_title"]); ?></td>
                                    <td><?php echo ($list["lang_name"]); ?></td>
                                    <td><?php echo (date("Y-m-d H:i",$list["create_time"])); ?></td>
                                    <td>
                                        <a href="<?php echo U('News/edit',array('groupId'=>$list['group_id']));?>" class="btn btn-primary" style="margin-bottom:0px;padding: 2px 9px;font-size:12px;">编辑</a>&nbsp;&nbsp;
                                        ...
                                        <!--<a href="<?php echo U('News/revoke',array('news_id'=>$list['news_id']));?>" class="btn btn-primary" style="margin-bottom:0px;padding: 2px 9px;font-size:12px;">撤销</a>&nbsp;&nbsp;-->
                                        <!--<a href="<?php echo U('News/publish',array('news_id'=>$list['news_id']));?>" class="btn btn-primary" style="margin-bottom:0px;padding: 2px 9px;font-size:12px;">发布</a>&nbsp;&nbsp;-->
                                    </td>
