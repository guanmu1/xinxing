    ...
    <div class="row">
        <div class="col-lg-12  ">
            <div class="ibox float-e-margins">
                ...
                <form class="form-horizontal m-t content-forms"  method="post">
                    <div class="ibox-content">
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><font color="red">*</font>所属上级：</label>
                            <div class="col-sm-9">
                                <select name="pid" class="form-control" id="pid">
                                    <option value="0">请选择商品分类</option>
                                    <?php if(is_array($cateInfo)): foreach($cateInfo as $key=>$_cate): if($info['pid'] == $_cate['category_id']): ?><option value="<?php echo ($_cate["category_id"]); ?>" selected="selected"><?php echo ($_cate["category_name"]); ?></option>
                                            <?php else: ?>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><font color="red">*</font>商品分类中文名称：</label>
                            <div class="col-sm-9">
                                <input name="name[]" class="form-control input-title" type="text" value="<?php echo ($info["cn"]); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><font color="red">*</font>商品分类英语名称：</label>
                            <div class="col-sm-9">
                                <input name="name[]" class="form-control input-title" type="text" value="<?php echo ($info["en"]); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><font color="red">*</font>商品分类法语名称：</label>
                            <div class="col-sm-9">
                                <input name="name[]" class="form-control input-title" type="text" value="<?php echo ($info["fr"]); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><font color="red">*</font>商品分类西班牙语名称：</label>
                            <div class="col-sm-9">
                                <input name="name[]" class="form-control input-title" type="text" value="<?php echo ($info["es"]); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><font color="red">*</font>商品分类葡萄牙语名称：</label>
                            <div class="col-sm-9">
                                <input name="name[]" class="form-control input-title" type="text" value="<?php echo ($info["pt"]); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><font color="red">*</font>商品分类俄语名称：</label>
                            <div class="col-sm-9">
                                <input name="name[]" class="form-control input-title" type="text" value="<?php echo ($info["ru"]); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><font color="red">*</font>商品分类阿拉伯语名称：</label>
                            <div class="col-sm-9">
                                <input name="name[]" class="form-control input-title" type="text" value="<?php echo ($info["ar"]); ?>">
                            </div>
                        </div>
                    </div>
                </form>
                ...
                <div style="margin-top: 10px;" class="form-group">
                    <div class="col-sm-3 " style="float: right;">
                        ...
                        <a class="btn btn-primary" href="<?php echo U('Category/index');?>">取消</a>
                    </div>
                </div>
...
//        });
        ...
        $(".content-forms input").each(function(i,e){
            if($(this).val() == ''){
                alert("所有语言的商品分类名称全都必须填写。。。");
                return false;
            }
        })

        var postData = $(".content-forms").serialize() + '&pid=' + pid + '&groupId=' + groupId;
        $.post('<?php echo U("Category/edit");?>',postData,function(result){
            console.log(result);
            alert(result.info);
            location.href = result.url;
        });
