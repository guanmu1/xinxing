    ...
    <div id="templatemo_main_content">
        <div id="templatemo_sidebar">
            <div class="sidebar_content_box" style="height:100px;">
                <h3 style="text-align:center;margin-top:20px;color:red;font-weight:bold;"><?php echo L('人才引进');?></h3>
                <h5 style="text-align:center;margin-top:10px;color:#35bf35;">TALENT INTRODUCTION</h5>
            </div>
            <div class="sidebar_content_box" style="background:#fff;padding:0;">
                <ul  style="padding:0;">
                    <li class="mouseover-li left-sub-menu-hover"><a class="left-sub-menu-a-hover" href="#" ><?php echo L('招贤纳士');?></a></li>
        ...
        <div id="templatemo_content">
            ...
            <div class="sidebar_content_boxx" style="height:100px;">
                <h3 class="h3-content"><?php echo L('招贤纳士');?></h3>
            </div>
            <div class="news_container">
                <?php if(is_array($_list)): foreach($_list as $key=>$item): ?><div class="post">
                        <div class="" style="background-color: #EEEFF0;">
                            <div style="width:20px;background: red;height: 35px;float: left;"></div>
                            <span class="news-title-text" style="font-size: 16px;"><?php echo ($item["recruit_title"]); ?></span>
