                ...
                <div class="ibox-content">
                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline" role="grid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <button id="btn_skip_target" class="btn btn-info" onclick="location.href = '<?php echo U('Recruit/add');?>'">添加招聘信息</button>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example dataTable no-footer">
                            ...
                            <?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr class="gradeX">
                                    ...
                                    <!--<td><?php echo ($i); ?></td>-->
                                    <td><?php echo ($list["recruit_id"]); ?></td>
                                    <td><?php echo ($list["recruit_title"]); ?></td>
                                    <td><?php echo ($list["lang_name"]); ?></td>
                                    <td><?php echo (date("Y-m-d H:i",$list["create_time"])); ?></td>
                                    <td>
                                        <a href="<?php echo U('Recruit/edit',array('groupId'=>$list['group_id']));?>" class="btn btn-primary" style="margin-bottom:0px;padding: 2px 9px;font-size:12px;">编辑</a>&nbsp;&nbsp;
                                        ...
                                        <!--<a href="<?php echo U('Recruit/revoke',array('recruit_id'=>$list['recruit_id']));?>" class="btn btn-primary" style="margin-bottom:0px;padding: 2px 9px;font-size:12px;">撤销</a>&nbsp;&nbsp;-->
                                        <!--<a href="<?php echo U('Recruit/publish',array('recruit_id'=>$list['recruit_id']));?>" class="btn btn-primary" style="margin-bottom:0px;padding: 2px 9px;font-size:12px;">发布</a>&nbsp;&nbsp;-->
                                    </td>
                ...
                $.ajax({
                    ...
                    success:function(data){
                        if(data.status == 1){
                            ...
                            window.location.href = "<?php echo U('Recruit/index');?>";
                        }else{
                            bootbox.alert({
                                message: data.msg,
                                buttons: {
