                        ...
                        <div class="form-group">
                        	...
                        	<div class="col-sm-9">
							    <select name="pid" class="form-control" id="pid">
                                    ...
                                    <?php if(is_array($cateInfo)): foreach($cateInfo as $key=>$_cate): ?><option value="<?php echo ($_cate["category_id"]); ?>"><?php echo ($_cate["category_name"]); ?></option><?php endforeach; endif; ?>
                                </select>
							</div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input name="name[]" class="form-control input-title" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <form class="form-horizontal m-t content-form"  method="post" style="display: none;">
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select name="form[1][pid]" id="" class="form-control">
                ...
                <form class="form-horizontal m-t content-form"  method="post" style="display: none;">
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">所属上级：</label>
                            <div class="col-sm-9">
                               <select name="form[2][pid]" id="" class="form-control">
                                    <option value="0">顶级</option>
                                    <option value="11">1111</option>
                                    <option value="22">2222</option>
                                </select>
                ...
                <form class="form-horizontal m-t content-form"  method="post" style="display: none;">
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">所属上级：</label>
                            <div class="col-sm-9">
                                <select name="form[3][pid]" id="" class="form-control">
                                    <option value="0">顶级</option>
                                    <option value="11">1111</option>
                                    <option value="22">2222</option>
                                </select>
                ...
                <form class="form-horizontal m-t content-form"  method="post" style="display: none;">
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">所属上级：</label>
                            <div class="col-sm-9">
                                <select name="form[4][pid]" id="" class="form-control">
                                    <option value="0">顶级</option>
                                    <option value="11">1111</option>
                                    <option value="22">2222</option>
                                </select>
                ...
                <form class="form-horizontal m-t content-form"  method="post" style="display: none;">
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">所属上级：</label>
                            <div class="col-sm-9">
                                <select name="form[5][pid]" id="" class="form-control">
                                    <option value="0">顶级</option>
                                    <option value="11">1111</option>
                                    <option value="22">2222</option>
                                </select>
                ...
                <form class="form-horizontal m-t content-form"  method="post" style="display: none;">
                    <div class="ibox-content">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">所属上级：</label>
                            <div class="col-sm-9">
                                <select name="form[6][pid]" id="" class="form-control">
                                    <option value="0">顶级</option>
                                    <option value="11">1111</option>
                                    <option value="22">2222</option>
                                </select>
...
//            var titleVal = $(e).find(".input-title").val();//当前这个form表单的分类名称
//            if (!titleVal) {
//                alert('第'+(i+1)+'组分类名称为空，请填写后再提交');
//                flag = true;
//                return false;
//            }
//            if (langVal == 0) {
...
//        }
        ...
        var postData = $(".content-forms").serialize() + '&pid=' + pid;
        $.post('<?php echo U("Category/add");?>',postData,function(result){
//            console.log(result);
//            alert(result.info);
