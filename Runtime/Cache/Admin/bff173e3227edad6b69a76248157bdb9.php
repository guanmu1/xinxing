                ...
                <div class="ibox-content">
                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline" role="grid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <button id="btn_skip_target" class="btn btn-info" onclick="location.href = '<?php echo U('Range/add');?>'">新增范围</button>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example dataTable no-footer">
                            ...
                            <?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr class="gradeX">
                                    ...
                                    <td><?php echo ($i); ?></td>
                                    <!--<td><?php echo ($list["range_id"]); ?></td>-->
                                    <td><?php echo ($list["range_title"]); ?></td>
                                    <td><img src="<?php echo ($list["range_img"]); ?>" alt=""  height="30"></td>
                                    <!--<td><?php echo (getStatusName($list["video_status"])); ?></td>-->
                                    <td>
                                        <a href="<?php echo U('Range/edit',array('groupId'=>$list['group_id']));?>" class="btn btn-primary" style="margin-bottom:0px;padding: 2px 9px;font-size:12px;">编辑</a>&nbsp;&nbsp;
...
//                                }
//                            });
                            window.location.href = "<?php echo U('Range/index');?>";
                        }else{
                            bootbox.alert({
                                message: data.msg,
                                buttons: {
